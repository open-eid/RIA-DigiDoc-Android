...
class ConfigurationLoaderTest {
    ...
    fun setUp() {
        ...
        Files.copy(confFile, File(context.cacheDir, CACHED_CONFIG_JSON))
        Files.copy(publicKeyFile, File(context.cacheDir, CACHED_CONFIG_PUB))
        Files.copy(signatureFile, File(context.cacheDir, CACHED_CONFIG_RSA))
    }
