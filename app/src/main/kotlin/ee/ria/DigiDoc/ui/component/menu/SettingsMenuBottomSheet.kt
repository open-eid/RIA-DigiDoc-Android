...
fun SettingsMenuBottomSheet(
    ...
    @StringRes thirdButtonStringRes: Int = R.string.main_settings_menu_advanced,
    @StringRes firstButtonStringResContentDescription: Int = R.string.main_settings_menu_language,
    @StringRes secondButtonStringResContentDescription: Int = R.string.main_settings_menu_appearance,
    @StringRes thirdButtonStringResContentDescription: Int = R.string.main_settings_menu_advanced,
