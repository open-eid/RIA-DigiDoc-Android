...
val LightTertiary = Color(0xFF300e41)
val LightTertiaryContainer = Color(0xFF533166)
...
val LightOnTertiaryContainer = Color(0xFFF3C7FF)
...
val LightSurfaceVariant = Color(0xFFEEEDF3)
...
// dark
val DarkPrimary = Color(0xFFB1CBFF)
val DarkPrimaryContainer = Color(0xFF6F91CE)
val DarkSecondaryContainer = Color(0xFF313D54)
val DarkTertiary = Color(0xFFE8B4F8)
val DarkTertiaryContainer = Color(0xFF401750)
...
val DarkOnTertiary = Color(0xFF471E57)
val DarkOnTertiaryContainer = Color(0xFFD7A4E6)
...
val DarkSurfaceVariant = Color(0xFF1E2023)
